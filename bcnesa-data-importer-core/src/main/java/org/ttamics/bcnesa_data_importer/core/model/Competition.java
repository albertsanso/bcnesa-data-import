...
public enum Competition {
    ...
    BCN_SENIOR_PROVINCIAL_3A_B(CompetitionType.SENIOR, "3,B"),
    BCN_SENIOR_PROVINCIAL_3A_A(CompetitionType.SENIOR, "3,A"),
    BCN_SENIOR_PROVINCIAL_2A_B(CompetitionType.SENIOR, "2,B"),
    BCN_SENIOR_PROVINCIAL_2A_A(CompetitionType.SENIOR, "2,A"),
    BCN_SENIOR_PROVINCIAL_1A(CompetitionType.SENIOR, "1,A"),
